...
Route::group(['namespace' => 'Admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::get('/get-notification-count', 'DashboardController@getNotificationCount')->name('notification.get_count');
        Route::get('/get-notification', 'SystemController@get_notification')->name('get-notification');
        Route::post('/mark-notification-as-read', 'SystemController@markAsRead')->name('mark-notification-as-read');
        ...
        // Raw Management Route

        Route::group(['prefix' => 'raw', 'as' => 'raw.', 'middleware' => []], function () {
            Route::get('add-new', 'RawController@add_new')->name('add-new');
            Route::post('add-new/store', 'RawController@store')->name('store');
            Route::get('list', 'RawController@index')->name('index');
            Route::get('edit/{id}', 'RawController@edit')->name('edit');
            Route::post('update/{id}', 'RawController@update')->name('update');
            Route::delete('delete/{id}', 'RawController@delete')->name('delete');
        });
        ...
        Route::group(['prefix' => 'table', 'as' => 'table.', 'middleware' => ['module:table_management', 'app_activate:' . APPS['table_app']['software_id']]], function () {
            ...
            Route::get('print_qr_code/{id}', 'TableController@print_qr')->name('print.qr');
        });
        Route::group(['prefix' => 'inventory', 'as' => 'inventory.', 'middleware' => ['module:table_management', 'app_activate:' . APPS['table_app']['software_id']]], function () {
            ...
            Route::get('catogory', 'InventoryController@catogry')->name('categorylist');
            Route::post('categorystore', 'InventoryController@categorystore')->name('category.store');
            Route::delete('delete/{id}', 'InventoryController@delete')->name('delete');
        ...
        Route::group(['prefix' => 'waiter', 'as' => 'waiter.', 'middleware' => []], function () {
            Route::get('add-new', 'WaiterController@add_new')->name('add-new');
            Route::post('add-new', 'WaiterController@store');
            Route::get('list', 'WaiterController@list')->name('list');
            Route::get('update/{id}', 'WaiterController@edit')->name('update');
            Route::post('update/{id}', 'WaiterController@update');
            Route::delete('delete/{id}', 'WaiterController@delete')->name('delete');
            Route::get('status/{id}/{status}', 'WaiterController@status')->name('status');
        });
        ...
        Route::put('orders/verify-offline-payment/{orderId}', [OfflinePaymentMethodController::class, 'verifyOfflinePayment'])->name('verified');
    });
});