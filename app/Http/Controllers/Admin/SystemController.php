...
class SystemController extends Controller
{
    ...
    {
        $unread_notifications = $this->notification_template->where('readed', false)->get();

        $unread_notifications->each->update(['readed' => true]);

        $new_notification = $unread_notifications->count();
    ...
    public function markAsRead()
    {
        ...
        NotificationTemplate::where('id', $notificationId)->update(['readed' => true]);
