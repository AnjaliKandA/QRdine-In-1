...
dirSwitch?.addEventListener("change", (e) => {
  ...
  if (checkbox.checked) {
    ...
    rtlLink.href = "public/assets/css/vendors/bootstrap.rtl.min.css";
    localStorage.setItem("rtlcss", "public/assets/css/vendors/bootstrap.rtl.min.css");
...
rtlLink.href = localStorage.getItem("rtlcss") ? localStorage.getItem("rtlcss") : "public/assets/css/vendors/bootstrap.min.css";
