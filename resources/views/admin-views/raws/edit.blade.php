...
@section('title', translate('Edit Raw Material'))
    ...
    <div class="content container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.raw.update', ['id' => $raw->id]) }}" method="post" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" name="description" class="form-control" id="description"
                                            ...
                                            value="{{ $raw->description }}" required>
                                    </div>
                                </div>
                            </div>
                            <br>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="input-label" for="exampleFormControlSelect1">{{ translate('Select Category') }} <span class="text-danger">*</span></label>
                                        <select name="category_id" class="custom-select" required>
                                            ...
                                            @foreach ($categories as $category)
                                                <option value="{{ $category['id'] }}" @if($category['id'] == $raw->category_id) selected @endif>{{ $category['name'] }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="supplier_id[]" class="custom-select" multiple required>
                                            ...
                                            @foreach ($suppliers as $supplier)
                                                <option value="{{ $supplier->id }}" @if(in_array($supplier->id, $raw->suppliers->pluck('id')->toArray())) selected @endif>{{ $supplier->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" name="price" class="form-control" id="price"
                                            ...
                                            value="{{ $raw->price }}"  min="1" required>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label for="name">{{ translate('Quantity') }} <span
                                                class="text-danger">*</span></label>
                                        <input type="number" name="quantity" value="{{ $raw->quantity }}"
