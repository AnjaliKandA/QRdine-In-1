                            ...
                            <div class="col-12">
                                ...
                                <div class="row gy-4">
                                    ...
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <div class="form-group">
                                            <label class="input-label" for="preparation_time">{{ translate('Preparation Time (in minutes)') }}</label>
                                             <input type="number" name="preparation_time" class="form-control" placeholder="{{ translate('Enter preparation time') }}" required>
                                        </div>
                                    <div class="col-md-6 mb-4">
                            ...
                            <table class="table table-borderless table-thead-bordered table-nowrap table-align-middle card-table">
                                <thead class="thead-light">
                                    <tr>
                                        ...
                                        <th>{{ translate('Preparation Time') }}</th>
