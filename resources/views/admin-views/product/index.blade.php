                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="item_type" class="form-control js-select2-custom">
                                                            ...
                                                            <option value="1">{{ translate('Best Seller') }}</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                    ...
                                    <div class="card h-100">
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <select name="addon_ids[]" class="form-control choose_addons" id=""
                                                    multiple="multiple">
                                ...
                                <div class="col-12">
                                    <div class="card h-100">
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                <label class="input-label">{{ translate('Select_Addons') }}</label>
                                                <select name="extras[]" class="form-control choose_addons" 
                                                    multiple="multiple">
