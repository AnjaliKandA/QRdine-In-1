                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="item_type" class="form-control js-select2-custom">
                                                            ...
                                                            <option value="1" {{$product['set_menu']==1?'selected':''}}>{{translate('Best Seller')}}</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                            ...
                            <div class="row g-2">
                                    ...
                                    <div class="card h-100">
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <select name="addon_ids[]" class="form-control choose_addons" 
                                                 multiple="multiple">
                                                    @foreach(\App\Model\AddOn::orderBy('name')->where('type','Addon')->get() as $addon)
                                                        <option
                                ...
                                <div class="col-12">
                                    <div class="card h-100">
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                <label class="input-label">{{translate('Select_Extras')}}</label>
                                                <select name="extras[]" class="form-control choose_addons"  multiple="multiple">
                                                    @foreach(\App\Model\AddOn::orderBy('name')->where('type','Extras')->get() as $addon)
                                                        <option
                                                            value="{{$addon['id']}}" {{in_array($addon->id,json_decode($product['add_ons'],true))?'selected':''}}>{{$addon['name']}}</option>
                                                    @endforeach
                                                </select>
