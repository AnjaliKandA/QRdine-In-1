                        ...
                        <div class="card billing-section-wrap">
                            ...
                            <div class="p-2 p-sm-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="">
                                        <!-- Custom Radio -->
                                        <div class="form-control d-flex flex-column-3"><label class="custom-radio d-flex gap-2 align-items-center m-0">
                                                <input type="radio" class="active" name="order_type" onclick="select_order_type('dine_in')" {{ session()->has('order_type') && session()->get('order_type') == 'dine_in' ? 'checked' : '' }}>
