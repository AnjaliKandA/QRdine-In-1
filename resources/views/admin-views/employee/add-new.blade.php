    ...
    <div class="content container-fluid">
        ...
        <div class="d-flex flex-wrap gap-2 align-items-center mb-4">
            <h2 class="h1 mb-0 d-flex align-items-center gap-2">
                <img width="20" class="avatar-img" src="{{ asset('public/assets/admin/img/icons/employee.png') }}"
                    alt="">
                ...
                <form action="{{ route('admin.employee.add-new') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card mb-3">
                        <div class="card-header">
                            <h5 class="mb-0 d-flex align-items-center gap-2"><span class="tio-user"></span>
                                {{ translate('general_Information') }}</h5>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    {{-- <div class="form-group">
                                        ...
                                        <select class="custom-select" name="identity_type" id="identity_type" required>
                                            <option selected disabled>---{{ translate('select_Identity_Type') }}---
                                            </option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="identity_number" class="form-control"
                                            id="identity_number" required value="{{ old('identity_number') }}">
                                    </div> --}}
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                    ...
                    <div class="card mb-3">
                        <div class="card-header">
                            <h5 class="mb-0 d-flex align-items-center gap-2"><span class="tio-user"></span>
                                {{ translate('account_Information') }}</h5>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-merge">
                                            <input type="password" name="password"
                                                ...
                                                id="password" placeholder="{{ translate('Ex: 8+ Characters') }}" required
