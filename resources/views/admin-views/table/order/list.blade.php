    ...
    <div class="content container-fluid">
        ...
        <div class="d-flex flex-wrap gap-2 align-items-center mb-4">
            <h2 class="h1 mb-0 d-flex align-items-center gap-2">
                <img width="20" class="avatar-img" src="{{ asset('public/assets/admin/img/icons/all_orders.png') }}"
                    alt="">
                        ...
                        <div class="row gy-3 gx-2 align-items-end">
                            ...
                            <div class="col-md-4 col-lg-3">
                                ...
                                <select class="form-control" name="branch" onchange="filter_branch_orders(this.value)"
                                    ...
                                    <option value="0" {{ session('branch_filter') == 0 ? 'selected' : '' }}>
                            ...
                            <div class="col-12 col-lg-3 d-flex gap-2">
                                <button type="clear"
                                    class="btn btn-secondary flex-grow-1">{{ translate('Clear') }}</button>
                                <button type="submit"
                                    class="btn btn-primary text-nowrap flex-grow-1">{{ translate('Show Data') }}</button>
                            </div>
                        </div>
                    </form>
                </div>
                    ...
                    <div class="row g-2">
                            ...
                            <a class="order--card h-100" href="{{ route('admin.table.order.list', ['confirmed']) }}">
                                <div class="d-flex justify-content-between align-items-center">
                                    <h6 class="card-subtitle d-flex justify-content-between m-0 align-items-center">
                                        <img src="{{ asset('public/assets/admin/img/icons/confirmed.png') }}"
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <a class="order--card h-100" href="{{ route('admin.table.order.list', ['cooking']) }}">
                                <div class="d-flex justify-content-between align-items-center">
                                    <h6 class="card-subtitle d-flex justify-content-between m-0 align-items-center">
                                        <img src="{{ asset('public/assets/admin/img/icons/cooking.png') }}" alt="dashboard"
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <a class="order--card h-100" href="{{ route('admin.table.order.list', ['done']) }}">
                                <div class="d-flex justify-content-between align-items-center">
                                    <h6 class="card-subtitle d-flex justify-content-between m-0 align-items-center">
                                        <img src="{{ asset('public/assets/admin/img/icons/review.png') }}" alt="dashboard"
                                            class="oder--card-icon">
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <a class="order--card h-100" href="{{ route('admin.table.order.list', ['completed']) }}">
                                <div class="d-flex justify-content-between align-items-center">
                                    <h6 class="card-subtitle d-flex justify-content-between m-0 align-items-center">
                                        <img src="{{ asset('public/assets/admin/img/icons/product.png') }}" alt="dashboard"
                                            class="oder--card-icon">
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <a class="order--card h-100" href="{{ route('admin.table.order.list', ['canceled']) }}">
                                <div class="d-flex justify-content-between align-items-center">
                                    <h6 class="card-subtitle d-flex justify-content-between m-0 align-items-center">
                                        <img src="{{ asset('public/assets/admin/img/icons/canceled.png') }}"
                                            alt="dashboard" class="oder--card-icon">
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <a class="order--card h-100" href="{{ route('admin.table.order.running') }}">
                                <div class="d-flex justify-content-between align-items-center">
                                    <h6 class="card-subtitle d-flex justify-content-between m-0 align-items-center">
                                        <img src="{{ asset('public/assets/admin/img/icons/out_for_delivery.png') }}"
                                            alt="dashboard" class="oder--card-icon">
                            ...
                            <form action="{{ url()->current() }}" method="GET">
                                <div class="input-group">
                                    <input id="datatableSearch_" type="search" name="search" class="form-control"
                                        placeholder="{{ translate('Search by Order ID  Order Status or Transaction Reference') }}"
                                ...
                                <tr class="status-{{ $order['order_status'] }} class-all">
                                    ...
                                    <td class="text-capitalize">
                                        ...
                                        @elseif($order['order_status'] == 'processing')
                                            <span
                                                class="badge-soft-warning px-2 rounded">{{ translate('processing') }}</span>
                                        @elseif($order['order_status'] == 'picked_up')
                                            <span
                                                class="badge-soft-warning px-2 rounded">{{ translate('out_for_delivery') }}</span>
                                        @elseif($order['order_status'] == 'delivered')
                                            <span
                                                class="badge-soft-success px-2 rounded">{{ translate('delivered') }}</span>
                                        @elseif($order['order_status'] == 'cooking')
                                            <span
                                                class="badge-soft-success px-2 rounded">{{ translate('cooking') }}</span>
                                        @elseif($order['order_status'] == 'completed')
                                            <span
                                                class="badge-soft-success px-2 rounded">{{ translate('completed') }}</span>
                                        @else
                                            <span
                                                class="badge-soft-danger px-2 rounded">{{ str_replace('_', ' ', $order['order_status']) }}</span>
                                        @endif
                                    </td>
                                    <td class="text-capitalize">
                                        ...
                                        @else
                                            <span
                                                class="badge-soft-success px-2 rounded">{{ translate('delivery') }}</span>
                                        @endif
                                    </td>
                                    <td>
                                        <div class="d-flex justify-content-center gap-2">
                                            <a class="btn btn-sm btn-outline-primary square-btn"
                                                href="{{ route('admin.table.order.details', ['id' => $order['id']]) }}">
