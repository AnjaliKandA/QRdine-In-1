...
@section('title', translate('Waiter List'))
                    ...
                    <div class="row justify-content-between align-items-center gy-2">
                        ...
                        <div class="col-md-8">
                            <div class="d-flex flex-wrap justify-content-md-end gap-3">
                                ...
                                <a href="{{route('admin.waiter.add-new')}}" class="btn btn-primary text-nowrap">
                                    <i class="tio-add"></i>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label class="switcher">
                                            <input type="checkbox" class="switcher_input"
                                                   onclick="location.href='{{route('admin.waiter.status',[$chef['id'],$chef->is_active?0:1])}}'"
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center gap-2">
                                            <a href="{{route('admin.waiter.update',[$chef['id']])}}"
                                            class="btn btn-outline-info btn-sm square-btn"
                                            title="{{translate('Edit')}}">
                                                <i class="tio-edit"></i>
                                            </a>
                                            <a class="btn btn-outline-danger btn-sm square-btn" title="{{translate('Delete')}}" href="javascript:"
                                            onclick="form_alert('chef-{{$chef['id']}}','{{translate('Want to delete this Waiter ?')}}')">
                                                <i class="tio-delete"></i>
                                            </a>
                                        </div>
                                        <form action="{{route('admin.waiter.delete',[$chef['id']])}}"
