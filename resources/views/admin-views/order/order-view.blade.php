    ...
    <div class="content container-fluid">
        ...
        <div class="d-flex flex-wrap gap-2 align-items-center mb-3">
            <h2 class="h1 mb-0 d-flex align-items-center gap-1">
                <img width="20" class="avatar-img" src="{{ asset('public/assets/admin/img/icons/order_details.png') }}"
                    alt="">
                                  ...
                                  <div class="mt-2 d-flex flex-column">
                                            ...
                                            <div class="hs-unfold">
                                                <h5 class="text-capitalize">
                                                    ...
                                                    {{ translate('table no') }} : <label
                                                        class="badge badge-secondary">{{ $order->table_id ? $order->table_id : 'Table deleted!' }}</label>
                                                </h5>
                                            </div>
                                            @php
                                            $table=DB::table('tables')->where('number',$order->table_id)->first();
                                             ...
                                             <div class="hs-unfold">
                                                    <h5 class="text-capitalize">
                                                        ...
                                                        {{ translate('number of people') }} : <label
                                                            class="badge badge-secondary">{{ $table->capacity ?? 0 }}</label>
                                                    </h5>
                                                </div>
                                        @endif
                                    </div>
                                    <div class="">
                                        {{ translate('Order_Date_&_Time') }}: <i
                                            class="tio-date-range"></i>{{ date('d M Y', strtotime($order['created_at'])) }}
...
@endphp
                                                ...
                                                @else
                                                    <a class="btn btn-outline-dark" href="javascript:"
                                                        onclick="last_location_view()" data-toggle="tooltip"
                                                        data-placement="top"
                            ...
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th>{{ translate('Item Details') }}</th>
                                     {{-- <th>{{ translate('Preferences') }}</th> --}}
                                     <th>{{ translate('Cooking Ins') }}</th>
                                        ...
                                        <td>
                                            <div class="media gap-3 w-max-content">
                                                ...
                                                <div class="media-body text-dark fz-12">
                                                    ...
                                                    <h6 class="text-capitalize">{{ $productdetail['name'] ?? '' }}</h6>
                                                    ...
                                                    {{-- <div class="d-flex gap-2">
                                                        <span class="">{{ translate('Size') }} : </span>
                                                        <span>full</span>
                                                    </div> --}}
                            ...
                            <div class="col-md-9 col-lg-8">
                                <dl class="row">
                                    ...
                                    <dd class="col-6 text-dark text-right">
                                        {{ \App\CentralLogics\Helpers::set_symbol($sub_total) }}</dd>
                                    ...
                                    <dd class="col-6 text-dark text-right">
                                        {{ \App\CentralLogics\Helpers::set_symbol($total_tax + $add_ons_tax_cost) }}</dd>
                                    ...
                                    <dd class="col-6 text-dark text-right">
                                        {{ \App\CentralLogics\Helpers::set_symbol($total_dis_on_pro) }}</dd>
                                    ...
                                    <dd class="col-6 text-dark text-right">
                                        {{ \App\CentralLogics\Helpers::set_symbol($sub_total = $sub_total + $total_tax + $add_ons_cost - $total_dis_on_pro + $add_ons_tax_cost) }}
                                    </dd>
                                    ...
                                    <dt class="col-6" style="display: none;">
                                        <div class="d-flex max-w220 ml-auto">
                                            <span>
                                    ...
                                    <dd class="col-6 text-dark text-right" style="display: none;">
                                    ...
                                    <dd class="col-6 border-top pt-2 fz-16 font-weight-bold text-dark text-right">
                                        {{ \App\CentralLogics\Helpers::set_symbol($sub_total - $order['coupon_discount_amount'] - $order['extra_discount'] + $del_c) }}
                                    </dd>
                        ...
                        <div class="card-body text-capitalize d-flex flex-column gap-4">
                                            ...
                                            @else
                                                ...
                                                @if ($order['order_type'] == 'dine_in')
                                                    <a class="dropdown-item"
                                                        ...
                                                        <a class="dropdown-item"
                                                        onclick="route_alert('{{ route('admin.orders.status', ['id' => $order['id'], 'order_status' => 'serve']) }}','{{ translate('Change status to serve ?') }}')"
                                                        href="javascript:">{{ translate('Ready To serve') }}</a>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center gap-10 form-control">
                                        ...
                                        @if ($order['payment_method'] == 'offline_payment' && $order->offline_payment?->status != 1)
                                            <label class="switcher payment-status-text">
                                                <input class="switcher_input" type="checkbox" name="payment_status"
                                                    value="1" id="payment_status_switch"
                            ...
                            @if ($order->customer || $order->is_guest == 1)
                                <div class="">
                                    {{-- need change option --}}
                                    <label
                                        class="font-weight-bold text-dark fz-14">{{ translate('Delivery_Date_&_Time') }}
                                        {{ $order['delivery_date'] > \Carbon\Carbon::now()->format('Y-m-d') ? translate('(Scheduled)') : '' }}</label>
                                    <div class="d-flex gap-2 flex-wrap flex-xxl-nowrap">
                                        <input onchange="changeDeliveryTimeDate(this)" name="delivery_date"
                                            type="date" class="form-control"
                                            value="{{ $order['delivery_date'] ?? '' }}">
                                        <input onchange="changeDeliveryTimeDate(this)" name="delivery_time"
                                ...
                                @if (
                                    ...
                                    <div class="form-control justify-content-between">
                                        <span class="ml-2 ml-sm-3 ">
                                            ...
                                            <i class="tio-edit p-2 d-none" id="edit-icon" style="cursor: pointer;"
                                                data-toggle="modal" data-target="#counter-change"
                                                data-whatever="@mdo"></i>
                                        </span>
                                    </div>
                                @endif
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="media flex-wrap gap-3">
                                            ...
                                            <div class="media-body d-flex flex-column gap-1">
                                                <a target="" href="#"
                                                    class="text-dark"><span>{{ $order->delivery_man['f_name'] . ' ' . $order->delivery_man['l_name'] ?? '' }}</span></a>
                                                <span class="text-dark">
                                                    <span>{{ $order->delivery_man['orders_count'] }}</span>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="delivery--information-single flex-column">
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <div class="info">{{ $address ? $address['contact_person_name'] : '' }}
                                                </div>
                                            </div>
                                            <div class="d-flex">
                    ...
                    <div class="card-body">
                        ...
                        @if ($order->is_guest == 1)
                            <div class="media flex-wrap gap-3 align-items-center">
                                <a target="#" class="">
                                    <img class="avatar avatar-lg rounded-circle"
                                        src="{{ asset('public/assets/admin/img/160x160/img1.jpg') }}" alt="Image">
                                </a>
                                <div class="media-body d-flex flex-column gap-1">
                                    <a target="#"
                        ...
                        @else
                         @php($customer=DB::table('customer_addresses')->where('order_no',$order->id)->first())
                                ...
                                <div class="media flex-wrap gap-3">
                                 <a target="#" class="">
                                    ...
                                    <div class="media-body d-flex flex-column gap-1">
                                        <a target="_blank"
                                            href="#"
                                            class="text-dark"><strong>{{$customer->contact_person_name ?? 0 }}</strong></a>
                                      
                                            
                                            <a class="text-dark break-all"
                                                href="tel:{{ $customer->contact_person_number }}">{{$customer->contact_person_number ?? 0 }}</a>
                                        </span>
                                ...
                                @else
                                 <div class="media-body d-flex flex-column gap-1">
                                        {{-- <a target="#"
                                         ...
                                         <a target="#"
                                            class="text-dark text-capitalize"><strong>{{translate('Anonymous')}}</strong></a>   
                                    </div>
                            @endif
                    ...
                    <div class="card-body">
                        ...
                        <div class="media flex-wrap gap-3">
                            ...
                            <div class="media-body d-flex flex-column gap-1">
                                @if (isset($order->branch))
                                    ...
                                    <span class="text-dark"> <span>{{ $order->branch['orders_count'] }}</span>
                                        {{ translate('Orders served') }}</span>
                                    @if ($order->branch['phone'])
                                        <span class="text-dark break-all">
                                            <i class="tio-call-talking-quiet mr-2"></i>
                                            <a class="text-dark"
                                                href="tel:{{ $order->branch?->phone }}">{{ $order->branch?->phone }}</a>
                                        </span>
                                    @endif
                                    <span class="text-dark break-all">
                                        <i class="tio-email mr-2"></i>
                                        <a class="text-dark"
                                            href="mailto:{{ $order->branch?->email }}">{{ $order->branch->email }}</a>
                                    </span>
                                @else
                        ...
                        @if (isset($order->branch))
                            ...
                            <div class="d-flex align-items-center text-dark gap-3">
                                <img width="13" src="{{ asset('public/assets/admin/img/icons/location.png') }}"
                                    alt="">
                                <a target="_blank" class="text-dark"
    ...
    <!-- Modal -->
    <div class="modal fade" id="assignDeliveryMan" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
                    ...
                    <ul class="list-group">
                        @foreach ($delivery_man as $deliveryMan)
                            <li class="list-group-item d-flex flex-wrap align-items-center gap-3 justify-content-between">
                                ...
                                <a id="{{ $deliveryMan->id }}" onclick="addDeliveryMan(this.id)"
    ...
    <div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="deliveryInfoModal" id="deliveryInfoModal"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title h4" id="mySmallModalLabel">{{ translate('Update_Delivery_Informatrion') }}
                    </h5>
                    <button type="button" class="btn btn-xs btn-icon btn-ghost-secondary" data-dismiss="modal"
                        aria-label="Close">
                        <i class="tio-clear tio-lg"></i>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="address" cols="30" rows="3"
                                            placeholder="{{ translate('EX : Dhaka,_Bangladesh') }}" required>{{ $address['address'] ?? '' }}</textarea>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel" style="font-size: 20px">
                            {{ translate('Need time to prepare the food') }}</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <form action="{{ route('admin.orders.increase-preparation-time', ['id' => $order->id]) }}"
                        ...
                        <div class="modal-body">
                            <div class="form-group text-center">
                                <input type="number" min="0" name="extra_minute" id="extra_minute"
                                    class="form-control" placeholder="{{ translate('EX : 20') }}" required>
                            </div>

                            <div class="form-group flex-between">
                                <div class="badge text-info shadow" onclick="predefined_time_input(10)"
                                    style="cursor: pointer">{{ translate('10min') }}</div>
                                <div class="badge text-info shadow" onclick="predefined_time_input(20)"
                                    style="cursor: pointer">{{ translate('20min') }}</div>
                                <div class="badge text-info shadow" onclick="predefined_time_input(30)"
                                    style="cursor: pointer">{{ translate('30min') }}</div>
                                <div class="badge text-info shadow" onclick="predefined_time_input(40)"
                                    style="cursor: pointer">{{ translate('40min') }}</div>
                                <div class="badge text-info shadow" onclick="predefined_time_input(50)"
                                    style="cursor: pointer">{{ translate('50min') }}</div>
                                <div class="badge text-info shadow" onclick="predefined_time_input(60)"
                                    style="cursor: pointer">{{ translate('60min') }}</div>
                            </div>
                        </div>
...
@push('script_2')
        ...
        function addDeliveryMan(id) {
            $.ajax({
                ...
                success: function(data) {
                    if (data.status == true) {
                        toastr.success(
                            '{{ \App\CentralLogics\translate('Delivery man successfully assigned/changed') }}', {
                                CloseButton: true,
                                ProgressBar: true
                            });
                        setTimeout(function() {
                        ...
                        toastr.error(
                            '{{ \App\CentralLogics\translate('Deliveryman man can not assign/change in that status') }}', {
                                CloseButton: true,
                                ProgressBar: true
                            });
                    }
    ...
    @if (
        ...
        <script>
            ...
            var x = setInterval(function() {
                ...
                document.getElementById("counter").innerHTML = Math.abs(days) + "d " + Math.abs(hours) + "h " + Math
                    .abs(minutes) + "m " + Math.abs(seconds) + "s " + $text;
                if (distance < 0) {
    ...
    <script>
        function changeDeliveryTimeDate(t) {
            ...
            $.ajax({
                type: "GET",
                url: '{{ url('/') }}/admin/orders/ajax-change-delivery-time-date/{{ $order['id'] }}?' + t
                    .name + '=' + t.value,
                data: {
                    name: name,
                    value: value
                ...
                success: function(data) {
                    ...
                    if (data.status == true && name == 'delivery_date') {
                        toastr.success(
                            '{{ \App\CentralLogics\translate('Delivery date changed successfully') }}', {
                                CloseButton: true,
                                ProgressBar: true
                            });
                    } else if (data.status == true && name == 'delivery_time') {
                        toastr.success(
                            '{{ \App\CentralLogics\translate('Delivery time changed successfully') }}', {
                                CloseButton: true,
                                ProgressBar: true
                            });
                    } else {
