                        ...
                        <div class="hs-unfold">
                            <a class="js-hs-unfold-invoker btn btn-icon btn-ghost-secondary rounded-circle"
                               href="{{route('admin.notification')}}">
                                ...
                                <span id="notification-count" class="btn-status btn-status-c1">0</span>
                                 {{-- <a href="{{ route('admin.notification.count') }}" class="btn-status btn-status-c1">0</a> --}}
                            </a>
                        </div>
                    </li>
...
<script>
    $(document).ready(function () {
        ...
        // Set up an interval to refresh the count every 60 seconds (or any interval you prefer)
        setInterval(updateNotificationCount, 60000);

        function updateNotificationCount() {
            
            $.ajax({
                url: "{{ route('admin.notification.get_count') }}",
                type: 'GET',
                dataType: 'json',
