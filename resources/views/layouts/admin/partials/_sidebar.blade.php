                ...
                <div class="navbar-brand-wrapper justify-content-between">
                    ...
                    <a class="navbar-brand" href="{{ route('admin.dashboard') }}" aria-label="Front">
                        <img class="" style="object-fit: contain;"
                            onerror="this.src='{{ asset('assets/admin/img/logo3.png') }}'"
                ...
                <div class="navbar-vertical-content">
                    ...
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        @if (Helpers::module_permission_check(MANAGEMENT_SECTION['order_management']))
                            <li
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li
                                        class="nav-item {{ Request::is('admin/table/order/list/all') ? 'active' : '' }}">
                                    ...
                                    <li
                                        class="nav-item {{ Request::is('admin/table/order/list/pending') ? 'active' : '' }}">
                                        <a class="nav-link "
                                            href="{{ route('admin.table.order.list', ['pending']) }}" title="">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate sidebar--badge-container">
                                                <span>{{ translate('pending') }}</span>
                                                <span class="badge badge-soft-info badge-pill ml-1">
                                                    {{ \App\Model\Order::notPos()->dineIn()->where(['order_status' => 'pending'])->notSchedule()->count() }}
                                                </span>
                                            </span>
                                        </a>
                                    </li>
                                    ...
                                    <li
                                        ...
                                        <a class="nav-link "
                                            href="{{ route('admin.table.order.list', ['cooking']) }}" title="">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate sidebar--badge-container">
                                                {{ translate('cooking') }}
                                    ...
                                    <li
                                        class="nav-item {{ Request::is('admin/table/order/list/done') ? 'active' : '' }}">
                                    ...
                                    <li
                                        class="nav-item {{ Request::is('admin/table/order/running') ? 'active' : '' }}">
                        ...
                        @if (Helpers::module_permission_check(MANAGEMENT_SECTION['product_management']))
                            ...
                            <li
                                ...
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                    ...
                                    <span
                                        class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{ translate('category') }}
                                        {{ translate('setup') }}</span>
                                </a>
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                            ...
                            <!-- Pages -->
                            <li
                                class="navbar-vertical-aside-has-menu {{ Request::is('admin/addon*') || Request::is('admin/product*') || Request::is('admin/attribute*') || Request::is('admin/reviews/list') ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                    href="javascript:">
                                    <i class="tio-premium-outlined nav-icon"></i>
                                    <span
                                        class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{ translate('product') }}
                                        {{ translate('setup') }}</span>
                                </a>
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li class="nav-item {{ Request::is('admin/attribute*') ? 'active' : '' }}">
                                        <a class="nav-link " href="{{ route('admin.attribute.add-new') }}"
                                            ...
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{ translate('Product_Attributes') }}</span>
                                        </a>
                                    </li>
                                    <li class="nav-item {{ Request::is('admin/addon*') ? 'active' : '' }}">
                                        <a class="nav-link " href="{{ route('admin.addon.add-new') }}"
                                            ...
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{ translate('Product_Addon/ Extras') }}</span>
                                        </a>
                                    </li>
                                    ...
                                    <li
                                        class="nav-item {{ Request::is('admin/product/list') || Request::is('admin/product/edit*') ? 'active' : '' }}">
                            ...
                            <!----- Raw Management ----->
                            <li
                                class="navbar-vertical-aside-has-menu {{ Request::is('admin/raw*') ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                    href="javascript:">
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    style="display: {{ Request::is('admin/raw*') ? 'block' : 'none' }}">
                                    <li class="nav-item {{ Request::is('admin/raw/add-new') ? 'active' : '' }}">
                                        <a class="nav-link " href="{{ route('admin.raw.add-new') }}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{ translate('add_new') }}</span>
                                        </a>
                                    </li>
                                    <li class="nav-item {{ Request::is('admin/raw/index') ? 'active' : '' }}">
                                        <a class="nav-link" href="{{ route('admin.raw.index') }}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                        ...
                        @if (Helpers::module_permission_check(MANAGEMENT_SECTION['promotion_management']))
                            <li class="nav-item">
                                <small class="nav-subtitle">{{ translate('promotion') }}
                                    {{ translate('management') }}</small>
                                <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                            </li>
                        ...
                        @if (Helpers::module_permission_check(MANAGEMENT_SECTION['report_and_analytics_management']))
                            ...
                            <li class="nav-item {{ Request::is('admin/report/order') ? 'active' : '' }}">
                                <a class="nav-link " href="{{ route('admin.report.order') }}">
                                    ...
                                    <span class="text-truncate">{{ translate('order') }}
                                        {{ translate('report') }}</span>
                                </a>
                            </li>
                            ...
                            <li class="nav-item {{ Request::is('admin/report/product-report') ? 'active' : '' }}">
                                <a class="nav-link " href="{{ route('admin.report.product-report') }}">
                                    ...
                                    <span class="text-truncate">{{ translate('product') }}
                                        {{ translate('report') }}</span>
                                </a>
                            </li>
                            <li class="nav-item {{ Request::is('admin/report/sale-report') ? 'active' : '' }}">
                                <a class="nav-link " href="{{ route('admin.report.sale-report') }}">
                                    ...
                                    <span class="text-truncate">{{ translate('sale') }}
                                        {{ translate('report') }}</span>
                                </a>
                            </li>
                            {{--                                </ul> --}}
                        ...
                        @if (Helpers::module_permission_check(MANAGEMENT_SECTION['user_management']))
                            ...
                            <!--    </a>-->
                            <!--    <ul class="js-navbar-vertical-aside-submenu nav nav-sub"-->
                            <!--        style="display: {{ Request::is('admin/customer/wallet/add-fund') || Request::is('admin/customer/wallet/report') || Request::is('admin/customer/wallet/bonus*') ? 'block' : '' }}; top: 831.076px;">-->
                            <!--        <li-->
                            ...
                            <!--    </a>-->
                            <!--    <ul class="js-navbar-vertical-aside-submenu nav nav-sub"-->
                            <!--        style="display: {{ Request::is('admin/customer/loyalty-point/report') ? 'block' : '' }}; top: 831.076px;">-->
                            <!--        <li-->
                        ...
                        {{-- @if (Helpers::module_permission_check(MANAGEMENT_SECTION['user_management']))
                            <li
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li
                                        class="nav-item {{ Request::is('admin/delivery-man/add/add') ? 'active' : '' }}">
                                        <a class="nav-link " href="{{ route('admin.delivery-man.add') }}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span
                                                class="text-truncate">{{ translate('Add_New_Delivery_Man') }}</span>
                                        </a>
                                    </li>
                                    <li
                                    ...
                                    <li
                                        ...
                                        <a class="nav-link" href="{{ route('admin.delivery-man.reviews.list') }}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span
                                                class="text-truncate">{{ translate('Delivery_Man_Reviews') }}</span>
                                        </a>
                                    </li>
                        ...
                        @if (Helpers::module_permission_check(MANAGEMENT_SECTION['user_management']))
                            @if (auth('admin')->user()->admin_role_id == 1)
                                <li
                                    ...
                                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub "
                                        style="display: {{ Request::is('admin/custom-role*') || Request::is('admin/employee*') ? 'block' : '' }}">

                                        <li class="nav-item {{ Request::is('admin/custom-role*') ? 'active' : '' }}">
                                            <a class="nav-link" href="{{ route('admin.custom-role.create') }}"
                                                title="{{ translate('Staff Role Setup') }}">
                                                <span class="tio-circle nav-indicator-icon"></span>
                                                <span
                                                    class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                                    {{ translate('Saff Role Setup') }}</span>
                                            </a>
                                        </li>
                                        ...
                                        <li
                                            ...
                                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                                href="javascript:" title="{{ translate('Staff Setup') }}">
                                                <span class="tio-user mr-2"></span>
                                                <span
                                                    class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                                    {{ translate('Saff Setup') }}
                                                </span>
                                            </a>
                                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                                style="display: {{ Request::is('admin/employee*') ? 'block' : '' }}">
                                                <li
                                                    class="nav-item {{ Request::is('admin/employee/add-new') ? 'active' : '' }}">
                                                    <a class="nav-link "
                                                        href="{{ route('admin.employee.add-new') }}"
                                                ...
                                                <li
                                                    class="nav-item {{ Request::is('admin/employee/list') ? 'active' : '' }}">
                        ...
                        @if (Helpers::module_permission_check(MANAGEMENT_SECTION['table_management']))
                            ...
                            {{-- <li
                                class="navbar-vertical-aside-has-menu {{ Request::is('admin/waiter*') ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                    href="javascript:">
                                    <i class="tio-user nav-icon"></i>
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                        {{ translate('Waiter Assignments') }}
                                    </span>
                                    <!--<label class="badge badge-danger">{{ translate('addon') }}</label>-->
                                </a>
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    style="display: {{ Request::is('admin/waiter*') ? 'block' : 'none' }}">
                                    <li class="nav-item {{ Request::is('admin/waiter/add-new') ? 'active' : '' }}">
                                        <a class="nav-link " href="{{ route('admin.waiter.add-new') }}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{ translate('add_new') }}</span>
                                        </a>
                                    </li>
                                    <li class="nav-item {{ Request::is('admin/waiter/list') ? 'active' : '' }}">
                                        <a class="nav-link" href="{{ route('admin.waiter.list') }}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{ translate('List') }}</span>
                                        </a>
                                    </li>
                        ...
                        {{-- inventory --}}
                        @if (Helpers::module_permission_check(MANAGEMENT_SECTION['inventory']))
                            <li class="nav-item">
                                <small class="nav-subtitle">Inventory Management
                                </small>

                            </li>

                            <li
                                class="navbar-vertical-aside-has-menu {{ Request::is('admin/inventory/list') ||
                                Request::is('admin/promotion/create') ||
                                Request::is('admin/inventory/index')
                                    ? 'active'
                                    : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                    href="javascript:">
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    style="top: 391.823px; display: {{ Request::is('admin/inventory/list') || Request::is('admin/inventory/index') ? 'block' : '' }};">
                                    <li
                                        class="nav-item {{ Request::is('admin/table/list') || Request::is('admin/table/update*') ? 'active' : '' }}">
                                    ...
                                    <li
                                        class="nav-item {{ Request::is('admin/inventory/categorylist') ? 'active' : '' }}">
                                        <a class="nav-link" href="{{ route('admin.inventory.categorylist') }}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                        ...
                        @if (Helpers::module_permission_check(MANAGEMENT_SECTION['system_management']))
                            ...
                            {{-- <li
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <!-- Social Link page -->
                                    <li
                                        class="navbar-vertical-aside-has-menu {{ Request::is('admin/business-settings/web-app/social-media') ? 'active' : '' }}">
                                        <a class="nav-link "
