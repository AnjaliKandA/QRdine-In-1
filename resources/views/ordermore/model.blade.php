      ...
      <div class="product-box-modal ratio_40">
        <div class="product-img">
          <img class="bg-img" src="{{ env('URL') . 'backend/storage/app/public/product/' . $products->image  }}" alt="rp1" style="    width: 100%;
    border-radius: 19px;
    height: 188px;" />
        </div>
        <div class="product-content">
          <div class="product-info">
            ...
            <div class="product-price">
              <h6 class="fw-semibold"><span>{{$products->price ?? 0}}</span> / {{$products->price + $products->discount }}</h6>
            </div>
          </div>
