        ...
        < action="{{route('non.filter')}}" method="post">
            @CSRF --}}
                ...
                @if ($type == 'veg')
                    ...
                    <li>
                        <a onclick="redirect()" class="food-types active ">
                            <img class="img-fluid img" src="{{ asset('assets/images/icons/veg.svg') }}" alt="veg" />
                    ...
                    <form action="{{ route('non.filter') }}" method="get">
                        ...
                        <li>
                            <a href="#" class="food-types ">
                                <img class="img-fluid img" src="{{ asset('public/assets/images/svg/nonveg.svg') }}"
                                    alt="non-veg" />
                ...
                @elseif($type == 'non_veg')
                    <form action="{{ route('non.filter') }}" method="get">
                        ...
                        <li>
                            <a href="#" class="food-types filter">
                                <img class="img-fluid img" src="{{ asset('public/assets/images/svg/veg.svg') }}"
                                    alt="non-veg" />
                                <h6><input type="submit" value="Veg" class="filter" /></h6>
                                <i class="ri-close-line close"></i>
                            </a>
                ...
                @elseif($type == 1)
                    ...
                    <li>
                        <a onclick="redirect()" class="food-types filter active ">
                            <i class="ri-award-fill award"></i>
                            <h6><input type="submit" value="Best Seller" class="filter" /></h6>
                            <i class="ri-close-line close"></i>
                        </a>
                                ...
                                <div class="accordion-body">
                                    <div class="product-box2">
                                        <div class="product-content">
                                            ...
                                            @if ($type == 'veg')
                                                <img class="img" src="{{ asset('assets/images/svg/veg.svg') }}"
                                                    alt="veg" />
                                            @elseif($type == 'non_veg')
                                                <img class="img" src="{{ asset('assets/images/svg/nonveg.svg') }}"
                                                    alt="non-veg" />
                                            @elseif($type == 1)
                                        ...
                                        <div class="product-img">
                                            <a href="#product-popup" data-bs-toggle="offcanvas">
                                                <img class=" img"
                                                    ...
                                                    alt="rp1" style="    width: 120px;height: 100px;"
                                                    onclick="modeldata({{ $data->id }})" />
                                            </a>
                                            <div class="add-btn">
                                                ...
                                                @if (Cart::count() > 0)
                                                    ...
                                                    <a class="btn
                                                        ...
                                                        data-value="{{ $data->id }}" data-bs-target="#add-product"
...
<script>
    $(document).ready(function() {
        ...
        $('.filter').click(function() {
            ...
            // Check if the current filter was already checked
            if (isChecked) {
                clickTimeout = setTimeout(function() {
                    // If the filter was already active, uncheck it and remove from active filters
                ...
                // If the filter was unchecked, remove it from active filters
                delete activeFilters[filterName];
            }
            ...
            // Pass the selected filters to the AJAX request or reload the page
            $.ajax({
