...
<body>
    ...
    <div class="confirm-title">
        ...
        <img class="img-fluid confirm-offer for-dark" src="assets/images/gif/success-payment-dark.gif"
            alt="success-payment" />
        <h2 class="dark-text text-center fw-semibold mt-2">Order Placed Successfully</h2>
        <h5 class="mt-3 dark-text text-center w-75 mx-auto">Your Order Placed Successful! Just wait
            your
            Mouth watering is </h5>
    </div>

    <a href="{{ route('order.order_track') }}" class="btn theme-btn w-100 mt-4" role="button">Track Order Now</a>

    {{-- <a href="{{ route('home') }}" class="btn btn-link mt-0">Back to Home</a> --}}
    </div>
