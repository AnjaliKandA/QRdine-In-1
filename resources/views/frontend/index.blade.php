...
.full-description {
    ...
    <section>
        <div class="custom-container" style="height: 0;">
                        ...
                        <div class="offer-box">
                            <div class="offer-icon">
                                <img class="img-fluid offer"
                                    src="{{ asset('public/assets/images/icons/Offer-Discount.png') }}" alt="offer" />
                            </div>
        ...
        <div class="custom-container">
            <ul class="food-symbol">
                ...
                <form action="{{ route('non.filter') }}" method="get">
                    ...
                    <li>
                        <a class="food-types">
                            <img class="img-fluid img" src="{{ asset('public/assets/images/icons/veg.svg') }}"
                                alt="veg" />
    ...
    <section class="food-list-section section-b-space">
        <div class="custom-container">
            ...
            `                                       <span id="fullDescription_{{ $data->id }}" class="full-description" style="display:none;">{{ $data->description }}</span>{{ Str::limit($data->description, 50) }} 
                                                    <span id="readMore_{{ $data->id }}" class="read-more" onclick="toggleDescription({{ $data->id }})">Read More</span>
                                                </p>
                                            </div>
...
<script>
 function toggleDescription(productId) {
        var readMoreLink = document.querySelector(`#readMore_${productId}`);
        var fullDescription = document.querySelector(`#fullDescription_${productId}`);
