...
@section('content')
                ...
                <div class="horizontal-product-box mt-3">
                    <div class="product-img">
                        <img class="img-fluid img"
                            src=" {{asset('storage/app/public/product/' . $data->options->image)}}"
                            alt="rp1" />
                    </div>
            ...
            <a href="#" class="apply-coupon">
                <div>
                    ...
                    <input class="dark-text form-control" id='ins' placeholder="Enter your cooking instruction here"
                        style="border: none; width: 300px; margin-top: 15px;" />
    ...
    <section class="bill-details">
        ...
        <li class="cart-add-box payment-card-box gap-0 mt-3" onclick="selectPaymentOption(1)">
            <div class="payment-detail">
                ...
                <div class="add-content">
                    <div>
                        <h5 class="fw-semibold">Phone Pe</h5>
                    </div>
        ...
        <li class="cart-add-box payment-card-box gap-0 mt-3" onclick="selectPaymentOption(2)">
            <div class="payment-detail" style="margin-bottom: 27px;">
                <div class="add-img">
    ...
    <script>
        function selectPaymentOption(value) {
            ...
            $('input[name="flexRadioDefault"][value="' + value + '"]').prop('checked', true);
        }
    </script>
    ...
    @if (Cart::count() > 0)
        <div class="pay-popup">
            ...
            <a onclick="cartdata()" class="btn theme-btn pay-btn mt-0">Proceed To Checkout</a>
        </div>
    @endif
